...
data class Tpp(val sessionToken: String, val directoryUser: UserRegistrationRequest,
    ...
    fun dynamicRegistration(registrationRequest: RegistrationRequest = RegistrationRequest(software_statement = generateSsa(), iss = softwareStatement.id)) : RegistrationResponse {
