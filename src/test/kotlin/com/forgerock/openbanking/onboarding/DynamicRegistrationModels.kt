...
import com.forgerock.openbanking.OB_SOFTWARE_ID
import com.forgerock.openbanking.REDIRECT_URI
...
data class RegistrationRequest(
        ...
        val request_object_encryption_enc: String? = asDiscovery.request_object_encryption_enc_values_supported.let { asDiscovery.request_object_encryption_enc_values_supported[0] },
        val request_object_signing_alg: String = "PS256",
        val response_types: List<String> = listOf("code id_token"),
        val scope: String = asDiscovery.scopes_supported.intersect(listOf("openid", "accounts", "payments", "fundsconfirmations")).joinToString(separator = " "),
