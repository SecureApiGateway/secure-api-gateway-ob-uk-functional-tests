...
import com.forgerock.openbanking.event.EventsDataFactory.Companion.anEventSubscriptionRequest
...
class CreateEventSubscriptionTest {
    ...
    fun shouldCreate_ExistsForTpp_v3_1_2() {
        ...
        // When
        val exception = assertThrows(AssertionError::class.java) { events.submitPost<OBEventSubscriptionResponse1>(url(version), request, credentials, tpp, version) }
