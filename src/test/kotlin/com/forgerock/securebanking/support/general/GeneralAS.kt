package com.forgerock.securebanking.support.general
...
open class GeneralAS {
    ...
    protected fun authenticate(authenticationURL: String, psu: UserRegistrationRequest): AuthenticationResponse {
