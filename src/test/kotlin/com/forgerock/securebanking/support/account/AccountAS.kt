...
//        val response = authenticate(authenticationURL, psu)
    ...
    private fun authenticateByHttpClient(
    ...
    @Deprecated("", ReplaceWith("authenticateByHttpClient"), DeprecationLevel.WARNING)
    private fun authenticate(authenticationURL: String, psu: UserRegistrationRequest): AuthenticationResponse {
    ...
    private fun continueAuthorize(authorizeURL: String, cookie: String): String {
    ...
    private fun getConsentDetails(consentRequest: String): ArrayList<String> {
    ...
    private fun getAuthCode(consentResponse: String, authorizeURL: String, cookie: String): String {
