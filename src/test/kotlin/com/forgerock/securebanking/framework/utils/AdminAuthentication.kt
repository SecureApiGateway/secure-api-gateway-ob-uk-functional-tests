...
const val ADMIN_USERNAME = "amadmin"
const val ADMIN_PASSWORD = "M4ymPctTY8wBG7lobdvmSTHc"
...
data class SuccessfulAuthenticationResponse(val tokenId: String, val successUrl: String, val realm: String)
...
fun adminAuthentication(): String {
    ...
    val gson = Gson()
    val authenticationResponse: SuccessfulAuthenticationResponse = gson.fromJson(result.component1(), SuccessfulAuthenticationResponse::class.java)
