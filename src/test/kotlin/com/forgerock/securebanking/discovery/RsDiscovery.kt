...
val fundsConfirmations3_0 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.0") }?.first()!!
}

val fundsConfirmations3_1 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.1") }?.first()!!
}

val fundsConfirmations3_1_1 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.1.1") }?.first()!!
}

val fundsConfirmations3_1_2 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.1.2") }?.first()!!
}

val fundsConfirmations3_1_3 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.1.3") }?.first()!!
}

val fundsConfirmations3_1_4 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.1.4") }?.first()!!
}

val fundsConfirmations3_1_5 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.1.5") }?.first()!!
}

val fundsConfirmations3_1_6 by lazy {
    rsDiscovery.Data.FundsConfirmationAPI?.filter { it.Version.equals("v3.1.6") }?.first()!!
}
...
private fun getRsConfiguration(): RsDiscovery {
    val (_, response, result) = Fuel.get("https://rs.aspsp.$DOMAIN/open-banking/discovery")
