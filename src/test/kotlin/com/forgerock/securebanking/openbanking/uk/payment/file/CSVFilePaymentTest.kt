...
class CSVFilePaymentTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    fun shouldCreateFilePaymentConsentFPS() {
        ...
        val consentRequest = filePaymentConsentWithAllFields(CSVFilePaymentType.UK_LBG_FPS_BATCH_V10.fileType, PaymentFactory.computeSHA256FullHash(file.toString()))
    ...
    fun shouldCreateFilePaymentConsentBULK() {
        ...
        val consentRequest = filePaymentConsentWithAllFields(CSVFilePaymentType.UK_LBG_BACS_BULK_V10.fileType, PaymentFactory.computeSHA256FullHash(file.toString()))
    ...
    fun shouldCreateCSVFilePaymentFPS_v3_1_2() {
        ...
        val consent = PaymentRS().consent<OBWriteFileConsentResponse2>(payment3_1_2.Links.links.CreateFilePaymentConsent, filePaymentConsentWithAllFields(CSVFilePaymentType.UK_LBG_FPS_BATCH_V10.fileType, fileHash, numberOfTransactions.toString(), controlSum.toString()), tppResource.tpp)
        // when
        val submissionFileResp = PaymentRS().submitCSVFilePayment(payment3_1_2.Links.links.CreateFilePaymentConsent + "/" + consent.data.consentId + "/file", file.toString(), CSVFilePaymentType.UK_LBG_FPS_BATCH_V10.contentType, tppResource.tpp)
        // then
        ...
        // When
        val paymentResult = PaymentRS().getPayment<OBWriteFileResponse2>(payment3_1_2.Links.links.CreateFilePayment, submissionResp.data.filePaymentId, accesstokenClientCredentials)
    ...
    fun shouldCreateCSVFilePaymentFPS_v3_1_4() {
        ...
        val consent = PaymentRS().consent<OBWriteFileConsentResponse2>(payment3_1_4.Links.links.CreateFilePaymentConsent, filePaymentConsentWithAllFields(CSVFilePaymentType.UK_LBG_FPS_BATCH_V10.fileType, fileHash, numberOfTransactions.toString(), controlSum.toString()), tppResource.tpp, v3_1_4)
        // when
        val submissionFileResp = PaymentRS().submitCSVFilePayment(payment3_1_4.Links.links.CreateFilePaymentConsent + "/" + consent.data.consentId + "/file", file.toString(), CSVFilePaymentType.UK_LBG_FPS_BATCH_V10.contentType, tppResource.tpp, v3_1_4)
        // then
        assertThat(submissionFileResp.statusCode).isEqualTo(200)
        assertThat(submissionFileResp.responseMessage).isEqualTo("OK")
    ...
    fun shouldCreateCSVFilePaymentFPS_v3_1_6() {
        ...
        val consent = PaymentRS().consent<OBWriteFileConsentResponse4>(payment3_1_6.Links.links.CreateFilePaymentConsent, filePaymentConsentWithAllFields(CSVFilePaymentType.UK_LBG_FPS_BATCH_V10.fileType, fileHash, numberOfTransactions.toString(), controlSum.toString()), tppResource.tpp, v3_1_6)
        // when
        val submissionFileResp = PaymentRS().submitCSVFilePayment(payment3_1_6.Links.links.CreateFilePaymentConsent + "/" + consent.data.consentId + "/file", file.toString(), CSVFilePaymentType.UK_LBG_FPS_BATCH_V10.contentType, tppResource.tpp, v3_1_6)
        // then
        assertThat(submissionFileResp.statusCode).isEqualTo(200)
        assertThat(submissionFileResp.responseMessage).isEqualTo("OK")
    ...
    fun shouldCreateCSVFilePaymentBULK_v3_1_2() {
        ...
        val controlSum = file.headerIndicatorSection.valueCreditsSum
        val fileHash = PaymentFactory.computeSHA256FullHash(file.toString())
        val consent = PaymentRS().consent<OBWriteFileConsentResponse2>(payment3_1_2.Links.links.CreateFilePaymentConsent, filePaymentConsentWithAllFields(CSVFilePaymentType.UK_LBG_BACS_BULK_V10.fileType, fileHash, numberOfTransactions.toString(), controlSum.toString()), tppResource.tpp)
        // when
        val submissionFileResp = PaymentRS().submitCSVFilePayment(payment3_1_2.Links.links.CreateFilePaymentConsent + "/" + consent.data.consentId + "/file", file.toString(), CSVFilePaymentType.UK_LBG_BACS_BULK_V10.contentType, tppResource.tpp)
        // then
        assertThat(submissionFileResp.statusCode).isEqualTo(200)
        assertThat(submissionFileResp.responseMessage).isEqualTo("OK")
    ...
    fun shouldCreateCSVFilePaymentBULK_v3_1_6() {
        ...
        val controlSum = file.headerIndicatorSection.valueCreditsSum
        val fileHash = PaymentFactory.computeSHA256FullHash(file.toString())
        val consent = PaymentRS().consent<OBWriteFileConsentResponse4>(payment3_1_6.Links.links.CreateFilePaymentConsent, filePaymentConsentWithAllFields(CSVFilePaymentType.UK_LBG_BACS_BULK_V10.fileType, fileHash, numberOfTransactions.toString(), controlSum.toString()), tppResource.tpp, v3_1_6)
        // when
        val submissionFileResp = PaymentRS().submitCSVFilePayment(payment3_1_6.Links.links.CreateFilePaymentConsent + "/" + consent.data.consentId + "/file", file.toString(), CSVFilePaymentType.UK_LBG_BACS_BULK_V10.contentType, tppResource.tpp, v3_1_6)
        // then
        assertThat(submissionFileResp.statusCode).isEqualTo(200)
        assertThat(submissionFileResp.responseMessage).isEqualTo("OK")
