package com.forgerock.openbanking.`as`
    ...
    fun shouldGetAccessTokenUsingTlsAuthCert() {
        ...
        if(supportsTlsClientAuth) {
            ...
            val tpp = initFuelAsNewTpp().apply {
                dynamicRegistration(RegistrationRequest(software_statement = generateSsa(),
            ...
            // When
            val (_, accessTokenResponse, result) = Fuel.post(asDiscovery.token_endpoint, parameters = listOf(
    ...
    fun shouldGetAccessTokenUsingPrivateKeyJwt() {
        ...
        if(supportsPrivateKeyJwt) {
            ...
            val clientAssertion = Jwts.builder()
                    ...
                    .setPayload(GsonBuilder().create().toJson(payload))
