package com.forgerock.securebanking.tests.functional.deprecated.payments
...
import com.forgerock.securebanking.framework.constants.UNAUTHORIZED
...
import com.forgerock.securebanking.support.payment.PaymentPayloadDeprecated
...
class SingleDomesticPaymentTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @EnabledIfVersion(
        type = "payments",
        apiVersion = "v3.1.2",
        operations = ["CreateDomesticPaymentConsent", "CreateDomesticPayment"],
    ...
    fun shouldCreateSingleDomesticPayment_v3_1_2() {
        ...
        val submissionResp = PaymentRS().submitPayment<OBWriteDomesticResponse2>(
            payment3_1_2.Links.links.CreateDomesticPayment,
        ...
        val paymentResult = PaymentRS().getPayment<OBWriteDomesticResponse2>(
            payment3_1_2.Links.links.CreateDomesticPayment,
            submissionResp.data.domesticPaymentId,
        ...
        assertThat(paymentResult.links.self).isEqualTo(payment3_1_2.Links.links.CreateDomesticPayment + "/" + submissionResp.data.domesticPaymentId)
    ...
    fun shouldCreateSingleDomesticPaymentConsent_noOptionalDebtorAccount_v3_1_4() {
        ...
        val getConsentResult = PaymentRS().getConsent<OBWriteDomesticConsentResponse4>(
            payment3_1_4.Links.links.CreateDomesticPaymentConsent + "/" + consent.data.consentId,
            tppResource.tpp
        )
    ...
    fun shouldCreateSingleDomesticPaymentConsent_v3_1_4_readRefund() {
        ...
        // Then
        assertThat(getConsentResult).isNotNull()
        assertThat(getConsentResult.data.readRefundAccount).isEqualTo(OBReadRefundAccountEnum.YES)
        assertThat(getConsentResult.data.consentId).isNotEmpty()
        Assertions.assertThat(getConsentResult.data.status.toString()).`is`(consentCondition)
        assertThat(getConsentResult.links.self).isEqualTo(payment3_1_4.Links.links.CreateDomesticPaymentConsent + "/" + consent.data.consentId)
        assertThat(getConsentResult.meta).isNotNull()
    ...
    fun shouldCreateSingleDomesticPayment_v3_1_4_readRefund() {
        ...
        val submissionResp = PaymentRS().submitPayment<OBWriteDomesticResponse4>(
    ...
    fun shouldCreateSingleDomesticPayment_v3_1_4_readRefund_debtorAccountNotPresent() {
        // Given
        val consentRequest = aValidOBWriteDomesticConsent4()
        val payloadConsent = PaymentPayloadDeprecated(
            Data = defaultMapper.writeValueAsString(consentRequest.data),
            Risk = defaultMapper.writeValueAsString(consentRequest.risk)
        )
    ...
    @EnabledIfVersion(type = "payments", apiVersion = "v3.1.6", apis = ["domestic-payment-consents"])
    @Test
    ...
    fun shouldCreateSingleDomesticPayment_v3_1_6() {
        ...
        val submissionResp = PaymentRS().submitPayment<OBWriteDomesticResponse5>(
            payment3_1_6.Links.links.CreateDomesticPayment,
            paymentSubmissionRequest,
            accessTokenAuthorizationCode,
            tppResource.tpp
        )
    ...
    fun shouldFailToCreateConsent_InvalidDetachedJws() {
        ...
        // When
        val response = PaymentRS().consentRequest_InvalidDetachedJws<OBWriteDomesticConsentResponse2>(
            payment3_1.Links.links.CreateDomesticPaymentConsent,
            consentRequest,
            tppResource.tpp
        )
    ...
    fun shouldFailToCreatePayment_InvalidDetachedJws() {
        ...
        val accessTokenSubmitPayment = PaymentAS().headlessAuthentication(
            consent.data.consentId,
            tppResource.tpp.registrationResponse,
            psu,
            tppResource.tpp
        ...
        // When
        val response = PaymentRS().submitPayment_InvalidDetachedJws<OBWriteDomesticResponse2>(
            payment3_1.Links.links.CreateDomesticPayment,
            paymentSubmissionRequest,
            accessTokenSubmitPayment
        )
    ...
    fun shouldFailToCreateConsent_DetachedJwsWithoutB64Claim() {
        ...
        // When
        val response = PaymentRS().consentRequest_DetachedJwsMissingB64Claim<OBWriteDomesticConsentResponse2>(
            payment3_1.Links.links.CreateDomesticPaymentConsent,
            consentRequest,
            tppResource.tpp
        )
