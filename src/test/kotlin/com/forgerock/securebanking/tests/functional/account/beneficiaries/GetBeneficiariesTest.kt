...
class GetBeneficiariesTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @Test
    fun shouldGetBeneficiaries_v3_1_1() {
        // Given
        val consentRequest = OBReadConsent1().data(
            OBReadData1()
                .permissions(listOf(READACCOUNTSDETAIL, READBENEFICIARIESDETAIL))
        ...
        // When
        val result = AccountRS().getAccountsData<OBReadBeneficiary3>(
            accountAndTransaction3_1_1.Links.links.GetBeneficiaries,
            accessToken
        )
    ...
    @Test
    fun shouldGetBeneficiaries_v3_1_6() {
        // Given
        val consentRequest = OBReadConsent1().data(
            OBReadData1()
                .permissions(listOf(READACCOUNTSDETAIL, READBENEFICIARIESDETAIL))
        ...
        // When
        val result = AccountRS().getAccountsData<OBReadBeneficiary3>(
            accountAndTransaction3_1_6.Links.links.GetBeneficiaries,
            accessToken
        )
