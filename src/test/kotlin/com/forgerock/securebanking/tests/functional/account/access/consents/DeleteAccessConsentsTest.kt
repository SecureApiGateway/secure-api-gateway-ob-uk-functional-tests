...
class DeleteAccessConsentsTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @Test
    fun deleteAccessConsents_v3_1_8() {
        // Given
        ...
        // When
        val result =
            AccountRS().deleteConsent<OBReadConsentResponse1>(
                AccountFactory.urlWithConsentId(
                    accountAndTransaction3_1_8.Links.links.DeleteAccountAccessConsent,
