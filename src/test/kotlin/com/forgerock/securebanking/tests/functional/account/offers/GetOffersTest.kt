...
class GetOffersTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    fun shouldGetOffers_v3_1() {
        ...
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            accountAndTransaction3_1.Links.links.GetOffers,
            accessToken
        )
    ...
    fun shouldGetOffers_v3_1_1() {
        ...
        // When
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            accountAndTransaction3_1_1.Links.links.GetOffers,
            accessToken
        )
    ...
    fun shouldGetOffers_v3_1_6() {
        ...
        // When
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            accountAndTransaction3_1_6.Links.links.GetOffers,
            accessToken
        )
