...
class GetAccountOffersTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @Test
    fun shouldGetAccountOffers_v3_1() {
        // Given
        ...
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            urlWithAccountId(
                accountAndTransaction3_1.Links.links.GetAccountOffers,
                accountId
            ), accessToken
        )
    ...
    @Test
    fun shouldGetAccountOffers_v3_1_1() {
        // Given
        val consentRequest = OBReadConsent1().data(
            OBReadData1()
                .permissions(listOf(READACCOUNTSDETAIL, READOFFERS))
        ...
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            urlWithAccountId(
                accountAndTransaction3_1_1.Links.links.GetAccountOffers,
                accountId
            ), accessToken
        )
    ...
    @Test
    fun shouldGetAccountOffers_v3_1_6() {
        // Given
        val consentRequest = OBReadConsent1().data(
            OBReadData1()
                .permissions(listOf(READACCOUNTSDETAIL, READOFFERS))
        ...
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            urlWithAccountId(
                accountAndTransaction3_1_6.Links.links.GetAccountOffers,
                accountId
            ), accessToken
        )
