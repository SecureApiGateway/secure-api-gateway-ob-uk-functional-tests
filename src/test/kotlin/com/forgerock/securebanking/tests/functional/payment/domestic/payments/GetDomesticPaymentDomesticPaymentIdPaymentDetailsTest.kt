package com.forgerock.securebanking.tests.functional.payment.domestic.payments
...
import com.forgerock.securebanking.support.payment.PaymentFactory.Companion.mapOBWriteDomestic2DataInitiationToOBDomestic2
import com.forgerock.securebanking.support.payment.PaymentFactory.Companion.urlWithDomesticPaymentId
...
class GetDomesticPaymentDomesticPaymentIdPaymentDetailsTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @Test
    fun getDomesticPaymentDomesticPaymentIdPaymentDetails_v3_1_1() {
        // Given
        ...
        val paymentResult = PaymentRS().getPayment<OBWritePaymentDetailsResponse1>(
            urlWithDomesticPaymentId(
                payment3_1_1.Links.links.GetDomesticPaymentDomesticPaymentIdPaymentDetails,
                submissionResponse.data.domesticPaymentId
            ),
            accessTokenClientCredentials,
            tppResource.tpp
