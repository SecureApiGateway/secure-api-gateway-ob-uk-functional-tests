package com.forgerock.uk.openbanking.tests.functional.account.direct.debits.legacy
...
class LegacyGetDirectDebitsTest(val tppResource: CreateTppCallback.TppResource) {
