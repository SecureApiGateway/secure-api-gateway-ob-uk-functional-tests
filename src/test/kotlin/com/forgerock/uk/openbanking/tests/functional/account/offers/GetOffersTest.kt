package com.forgerock.uk.openbanking.tests.functional.account.offers
...
class GetOffersTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    fun shouldGetOffers_v3_1_2() {
        ...
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            accountAndTransaction3_1_2.Links.links.GetOffers,
            accessToken
        )
    ...
    fun shouldGetOffers_v3_1_8() {
        ...
        // When
        val result = AccountRS().getAccountsData<OBReadOffer1>(
            accountAndTransaction3_1_8.Links.links.GetOffers,
            accessToken
        )
