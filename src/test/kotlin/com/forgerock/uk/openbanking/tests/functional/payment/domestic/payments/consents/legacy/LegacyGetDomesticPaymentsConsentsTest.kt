package com.forgerock.uk.openbanking.tests.functional.payment.domestic.payments.consents.legacy
...
class LegacyGetDomesticPaymentsConsentsTest(val tppResource: CreateTppCallback.TppResource) {
