package com.forgerock.sapi.gateway.ob.uk.tests.functional.payment.domestic.standing.order.consents.junit.v3_1_9
...
class CreateDomesticStandingOrderConsentsTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @Test
    fun createDomesticStandingOrdersConsents_NoIdempotencyKey_throwsBadRequestTest_v3_1_9(){
    ...
    @Test
    fun createDomesticStandingOrdersConsents_withDebtorAccount_v3_1_9() {
    ...
    @Test
    fun createDomesticStandingOrdersConsents_throwsInvalidDebtorAccount_v3_1_9() {
