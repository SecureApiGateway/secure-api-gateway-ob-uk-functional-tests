...
class CreateInternationalStandingOrderConsentsTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @Test
    fun createInternationalStandingOrdersConsents_withDebtorAccount_v3_1_8() {
    ...
    @Test
    fun createInternationalStandingOrdersConsents_throwsInvalidDebtorAccount_v3_1_8() {
    ...
    @Test
    fun createInternationalStandingOrdersConsents_mandatoryFields_v3_1_8() {
    ...
    @Test
    fun shouldCreateInternationalStandingOrdersConsents_throwsInvalidFrequencyValue_v3_1_8() {
    ...
    @Test
    fun shouldCreateInternationalStandingOrdersConsents_throwsSendInvalidFormatDetachedJws_v3_1_8() {
    ...
    @Test
    fun shouldCreateInternationalStandingOrdersConsents_throwsNoDetachedJws_v3_1_8() {
    ...
    @Test
    fun shouldCreateInternationalStandingOrdersConsents_throwsNotPermittedB64HeaderAddedInTheDetachedJws_v3_1_8() {
    ...
    @Test
    fun shouldCreateInternationalStandingOrdersConsents_throwsSendInvalidKidDetachedJws_v3_1_8() {
    ...
    @Test
    fun shouldCreateInternationalStandingOrdersConsents_throwsRejectedConsent_v3_1_8() {
