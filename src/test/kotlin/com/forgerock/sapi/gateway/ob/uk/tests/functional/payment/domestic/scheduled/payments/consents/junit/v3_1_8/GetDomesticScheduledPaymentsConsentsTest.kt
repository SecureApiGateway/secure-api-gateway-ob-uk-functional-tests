package com.forgerock.sapi.gateway.ob.uk.tests.functional.payment.domestic.scheduled.payments.consents.junit.v3_1_8
...
class GetDomesticScheduledPaymentsConsentsTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @BeforeEach
    fun setUp() {
        getDomesticScheduledPaymentsConsentsApi = GetDomesticScheduledPaymentsConsents(OBVersion.v3_1_8, tppResource)
    }
