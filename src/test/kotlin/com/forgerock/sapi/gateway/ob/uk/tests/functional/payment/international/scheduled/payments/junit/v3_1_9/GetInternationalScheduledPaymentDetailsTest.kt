package com.forgerock.sapi.gateway.ob.uk.tests.functional.payment.international.scheduled.payments.junit.v3_1_9
...
class GetInternationalScheduledPaymentDetailsTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    fun setUp() {
        getInternationalScheduledPaymentDetails =
            GetInternationalScheduledPaymentDetails(OBVersion.v3_1_9, tppResource)
    }
