...
class GetAccountStatementTransactionsTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @Test
    fun shouldGetAccountStatementTransactions_v3_1_8() {
        GetAccountStatementTransactions(OBVersion.v3_1_8, tppResource).shouldGetAccountStatementTransactionsTest()
    }
}