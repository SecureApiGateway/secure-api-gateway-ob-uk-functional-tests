...
class GetInternationalStandingOrderTest(val tppResource: CreateTppCallback.TppResource) {
    ...
    @BeforeEach
    fun setUp() {
        getInternationalStandingOrder = GetInternationalStandingOrder(OBVersion.v3_1_10, tppResource)
    }
    ...
    @Test
    fun getInternationalStandingOrders_v3_1_10() {
    ...
    @Test
    fun getInternationalStandingOrders_mandatoryFields_v3_1_10() {
