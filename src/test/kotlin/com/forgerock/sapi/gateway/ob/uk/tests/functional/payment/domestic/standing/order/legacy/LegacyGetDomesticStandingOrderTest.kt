...
import com.forgerock.sapi.gateway.ob.uk.support.payment.PaymentFactory.Companion.urlWithDomesticStandingOrderId
...
class LegacyGetDomesticStandingOrderTest(val tppResource: CreateTppCallback.TppResource) {
    @EnabledIfVersion(
        type = "payments",
        apiVersion = "v3.1.4",
