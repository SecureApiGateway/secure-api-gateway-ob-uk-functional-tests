...
import com.forgerock.sapi.gateway.ob.uk.generated.xml.model.pain00100108.Document
...
import uk.org.openbanking.testsupport.payment.OBWriteFileConsentTestDataFactoryV4
...
class PaymentFactoryV4 {
    ...
    companion object {
        ...
        fun createOBWriteFileConsent3WithFileInfo(fileContent: String, fileType: String): OBWriteFileConsent3 {
            ...
            return OBWriteFileConsentTestDataFactoryV4.aValidOBWriteFileConsent3(
                fileType,
                fileHashString,
        ...
        fun createOBWriteFileConsent3WithMandatoryFieldsAndFileInfo(
            ...
            val fileHashString = computeSHA256FullHash(fileContent)
            return OBWriteFileConsentTestDataFactoryV4.aValidOBWriteFileConsent3MandatoryFields(fileType, fileHashString)
        }
        ...
        fun copyOBWriteDomesticStandingOrder3DataInitiation(initiation: OBWriteDomesticStandingOrder3DataInitiation): OBWriteDomesticStandingOrder3DataInitiation {
            val copy = OBWriteDomesticStandingOrder3DataInitiation()
                ...
                .ultimateDebtor(initiation.ultimateDebtor)
                .remittanceInformation(initiation.remittanceInformation)
                .mandateRelatedInformation(initiation.mandateRelatedInformation)
                .regulatoryReporting(initiation.regulatoryReporting)
        ...
        fun copyOBWriteDomesticScheduledConsent4DataInitiation(initiation: OBWriteDomesticScheduledConsent4DataInitiation): OBWriteDomesticScheduledConsent4DataInitiation {
            val copy = OBWriteDomesticScheduledConsent4DataInitiation()
                .instructionIdentification(initiation.instructionIdentification)
                .endToEndIdentification(initiation.endToEndIdentification)
                .localInstrument(initiation.localInstrument)
        ...
        fun mapOBWriteDomesticStandingOrderConsentResponse6DataInitiationToOBWriteDomesticStandingOrder3DataInitiation(
            ...
            val outputInitiation = OBWriteDomesticStandingOrder3DataInitiation()
                ...
                .ultimateCreditor(inputInitiation.ultimateCreditor)
                .ultimateDebtor(inputInitiation.ultimateDebtor)
                .remittanceInformation(inputInitiation.remittanceInformation)
                .mandateRelatedInformation(inputInitiation.mandateRelatedInformation)
                .regulatoryReporting(inputInitiation.regulatoryReporting)
                .supplementaryData(inputInitiation.supplementaryData)
        ...
        fun mapOBWriteInternationalConsent5DataInitiationToOBWriteInternational3DataInitiation(
            initiation: OBWriteInternationalConsent5DataInitiation
        ): OBWriteInternational3DataInitiation {
            val internationalPaymentConsent = OBWriteInternational3DataInitiation()
                .instructionIdentification(initiation.instructionIdentification)
                .endToEndIdentification(initiation.endToEndIdentification)
                .localInstrument(initiation.localInstrument)
                .instructionPriority(initiation.instructionPriority)
            ...
            if (initiation.instructedAmount != null) {
                internationalPaymentConsent.instructedAmount(
                    OBWriteDomestic2DataInitiationInstructedAmount()
                        .amount(initiation.instructedAmount?.amount)
                        .currency(initiation.instructedAmount?.currency)
                )
            ...
            if (initiation.exchangeRateInformation != null) {
                internationalPaymentConsent.exchangeRateInformation(
                    OBWriteInternational3DataInitiationExchangeRateInformation()
                        .unitCurrency(initiation.exchangeRateInformation?.unitCurrency)
                        .exchangeRate(initiation.exchangeRateInformation?.exchangeRate)
                        .rateType(initiation.exchangeRateInformation?.rateType)
            ...
            if (initiation.debtorAccount != null) {
                internationalPaymentConsent.debtorAccount(
                    OBWriteDomestic2DataInitiationDebtorAccount()
                        .schemeName(initiation.debtorAccount?.schemeName)
                        .identification(initiation.debtorAccount?.identification)
                        .name(initiation.debtorAccount?.name)
            ...
            if (initiation.creditor != null) {
                internationalPaymentConsent.creditor(
            ...
            if (initiation.creditorAgent != null) {
                internationalPaymentConsent.creditorAgent(
            ...
            if (initiation.creditorAccount != null) {
                internationalPaymentConsent.creditorAccount(
                    OBWriteDomestic2DataInitiationCreditorAccount()
                        .schemeName(initiation.creditorAccount?.schemeName)
                        .identification(initiation.creditorAccount?.identification)
                        .name(initiation.creditorAccount?.name)
            ...
            if (initiation.remittanceInformation != null) {
                internationalPaymentConsent.remittanceInformation(
                    OBRemittanceInformation2()
                        .unstructured(initiation.remittanceInformation?.unstructured)
                )
            }
        ...
        fun mapOBWriteFileConsent3DataInitiationToOBWriteFile2DataInitiation(inputInitiation: OBWriteFileConsent3DataInitiation): OBWriteFile2DataInitiation? {
            ...
            if (inputInitiation.ultimateDebtor != null) {
                outputInitiation.ultimateDebtor(
                    OBUltimateCreditor1()
                        .schemeName(inputInitiation.debtorAccount?.schemeName)
                        .identification(inputInitiation.debtorAccount?.identification)
                        .name(inputInitiation.debtorAccount?.name)
        ...
        fun mapOBWriteDomesticScheduledConsent4DataInitiationToOBWriteDomesticScheduled2DataInitiation(inputInitiation: OBWriteDomesticScheduledConsent4DataInitiation): OBWriteDomesticScheduled2DataInitiation? {
            val outputInitiation = OBWriteDomesticScheduled2DataInitiation()
                .instructionIdentification(inputInitiation.instructionIdentification)
                .endToEndIdentification(inputInitiation.endToEndIdentification)
                .localInstrument(inputInitiation.localInstrument)
                .requestedExecutionDateTime(inputInitiation.requestedExecutionDateTime)
                .creditorPostalAddress(inputInitiation.creditorPostalAddress)
                .instructedAmount(inputInitiation.instructedAmount)
                .ultimateCreditor(inputInitiation.ultimateCreditor)
                .ultimateDebtor(inputInitiation.ultimateDebtor)
                .regulatoryReporting(inputInitiation.regulatoryReporting)
        ...
        fun copyOBWriteFileConsent3DataInitiation(initiation: OBWriteFileConsent3DataInitiation): OBWriteFileConsent3DataInitiation? {
            val copy = OBWriteFileConsent3DataInitiation()
                .fileHash(initiation.fileHash)
                .fileReference(initiation.fileReference)
                .fileType(initiation.fileType)
                .creditorAgent(initiation.creditorAgent)
