package com.forgerock.sapi.gateway.ob.uk.tests.functional.payment.domestic.standing.order.api.v4_0_0
...
import com.forgerock.sapi.gateway.ob.uk.framework.consent.payment.OBWriteDomesticStandingOrderConsent5FactoryV4
...
class GetDomesticStandingOrder(val version: OBVersion, val tppResource: CreateTppCallback.TppResource) {
    ...
    private val consentFactory = ConsentFactoryRegistryHolder.consentFactoryRegistry.getConsentFactory(
        OBWriteDomesticStandingOrderConsent5FactoryV4::class.java
    )
    ...
    fun shouldGetDomesticStandingOrders_withReadRefundTest() {
        // Given
        val consentRequest = consentFactory.createConsent()
        consentRequest.data.readRefundAccount = OBWriteDomesticScheduledConsent4DataReadRefundAccount.YES
        ...
        assertThat(consent.data.readRefundAccount).isEqualTo(OBWriteDomesticScheduledConsent4DataReadRefundAccount.YES)
    ...
    private fun getStandingOrder(standingOrderResponse: OBWriteDomesticStandingOrderResponse6): OBWriteDomesticStandingOrderResponse6 {
        val getDomesticPaymentUrl = PaymentFactoryV4.urlWithDomesticStandingOrderId(
