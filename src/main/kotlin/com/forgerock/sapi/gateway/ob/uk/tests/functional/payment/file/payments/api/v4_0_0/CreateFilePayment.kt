package com.forgerock.sapi.gateway.ob.uk.tests.functional.payment.file.payments.api.v4_0_0
...
class CreateFilePayment(val version: OBVersion, val tppResource: CreateTppCallback.TppResource) {
    ...
    private fun createFilePaymentRequest(
        ...
        return OBWriteFile2().data(
                OBWriteFile2Data()
                        .consentId(consentId)
                        .initiation(PaymentFactoryV4.mapOBWriteFileConsent3DataInitiationToOBWriteFile2DataInitiation(consentRequest.data.initiation))
        )
    }
}
