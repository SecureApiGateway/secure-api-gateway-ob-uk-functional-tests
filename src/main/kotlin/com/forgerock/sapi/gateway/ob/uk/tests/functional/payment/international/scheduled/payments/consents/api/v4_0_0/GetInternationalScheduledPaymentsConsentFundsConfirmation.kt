package com.forgerock.sapi.gateway.ob.uk.tests.functional.payment.international.scheduled.payments.consents.api.v4_0_0
...
import com.forgerock.sapi.gateway.ob.uk.framework.consent.payment.OBWriteInternationalScheduledConsent5FactoryV4
...
class GetInternationalScheduledPaymentsConsentFundsConfirmation(
    ...
    private val consentFactory = ConsentFactoryRegistryHolder.consentFactoryRegistry.getConsentFactory(
        OBWriteInternationalScheduledConsent5FactoryV4::class.java
    )
    ...
    private fun createPaymentRequest(consentResponse: OBWriteInternationalScheduledConsentResponse6): OBWriteInternationalScheduled3 {
        return OBWriteInternationalScheduled3().data(
            OBWriteInternationalScheduled3Data()
                ...
                .initiation(
                    PaymentFactoryV4.copyOBWriteInternationalScheduled3DataInitiation(
