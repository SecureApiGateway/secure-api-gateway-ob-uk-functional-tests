package com.forgerock.sapi.gateway.ob.uk.tests.functional.events.aggregatedpolling.api.v4_0_0
...
import com.forgerock.sapi.gateway.ob.uk.support.event.v4.EventNotificationRS
import com.forgerock.sapi.gateway.ob.uk.support.event.v4.EventsDataFactory
...
class AggregatedPolling(
    ...
    fun shouldInitialPollingTest() {
        ...
        val dataEventRequest = EventsDataFactory.aValidFRDataEvent(
                listOf(EventsDataFactory.aValidOBEventNotification1(OBVersion.v4_0_0)),
    ...
    fun shouldPollAndAcknowledgeEventTest() {
        ...
        val obEventNotifications = listOf(
                EventsDataFactory.aValidOBEventNotification1(OBVersion.v4_0_0),
                EventsDataFactory.aValidOBEventNotification1(OBVersion.v4_0_0)
        )
