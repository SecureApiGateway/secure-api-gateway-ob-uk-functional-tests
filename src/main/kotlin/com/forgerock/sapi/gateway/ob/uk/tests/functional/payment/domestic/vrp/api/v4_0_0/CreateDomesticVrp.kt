...
import uk.org.openbanking.testsupport.v4.vrp.OBDomesticVrpCommonTestDataFactory
...
//        }
    ...
    fun shouldFailToCreateVrpWhenMaxIndividualAmountBreachedTest() {
        ...
        assertThat((exception.cause as FuelError).response.statusCode).isEqualTo(400)
        assertThat(exception.message!!).contains("\"ErrorCode\":\"U014\"")
    ...
    private fun createPaymentRequest(
        ...
        return OBDomesticVRPRequest().data(
            OBDomesticVRPRequestData()
                    .consentId(consentId)
                    .vrPType(consentRequest.data.controlParameters.vrPType.get(0))
