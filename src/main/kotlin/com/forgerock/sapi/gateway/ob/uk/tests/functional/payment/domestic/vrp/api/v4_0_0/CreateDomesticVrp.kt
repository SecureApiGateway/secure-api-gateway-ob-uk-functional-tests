...
import uk.org.openbanking.testsupport.vrp.OBDomesticVrpCommonTestDataFactoryV4
...
//                OBDomesticVrpCommonTestDataFactoryV4.aValidOBCashAccountCreditor3()
//            )
//        }
    ...
    private fun createPaymentRequest(
        ...
        return OBDomesticVRPRequest().data(
            OBDomesticVRPRequestData()
                    .consentId(consentId)
                    .initiation(PaymentFactoryV4.copyOBDomesticVRPInitiation(consentRequest.data.initiation))
