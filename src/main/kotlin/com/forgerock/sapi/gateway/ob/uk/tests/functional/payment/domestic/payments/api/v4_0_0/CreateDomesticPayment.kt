...
class CreateDomesticPayment(
    ...
    private val consentFactory: OBWriteDomesticConsent4FactoryV4 =
        ConsentFactoryRegistryHolder.consentFactoryRegistry.getConsentFactory(OBWriteDomesticConsent4FactoryV4::class.java)
