package com.forgerock.sapi.gateway.ob.uk.tests.functional.payment.international.payments.consents.api.v4_0_0
...
import com.forgerock.sapi.gateway.ob.uk.framework.consent.payment.OBWriteInternationalConsent5FactoryV4
...
class GetInternationalPaymentsConsentFundsConfirmation(
    ...
    private val consentFactory = ConsentFactoryRegistryHolder.consentFactoryRegistry.getConsentFactory(
        OBWriteInternationalConsent5FactoryV4::class.java
    )
    ...
    private fun getFundsConfirmation(
        ...
        return paymentApiClient.sendGetRequest(
            PaymentFactoryV4.urlWithConsentId(
    ...
    private fun createPaymentRequest(consentResponse: OBWriteInternationalConsentResponse6): OBWriteInternational3 {
        return OBWriteInternational3().data(
            OBWriteInternational3Data()
                ...
                .initiation(PaymentFactoryV4.mapOBWriteInternationalConsent5DataInitiationToOBWriteInternational3DataInitiation(consentResponse.data.initiation))
