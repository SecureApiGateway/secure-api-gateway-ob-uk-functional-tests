...
println("DEBUG: User found? ${!System.getenv("FR_ARTIFACTORY_USER").isNullOrEmpty()}")
println("DEBUG: Password found? ${!System.getenv("FR_ARTIFACTORY_USER_ENCRYPTED_PASSWORD").isNullOrEmpty()}")
val user = System.getenv("FR_ARTIFACTORY_USER") ?: "null"
println("DEBUG User: ${user.toCharArray().joinToString(" ")}")
val user2 = System.getenv("FR_ARTIFACTORY_USER_ENCRYPTED_PASSWORD") ?: "null"
println("DEBUG User: ${user2.toCharArray().joinToString(" ")}")
/*
...
dependencies {
    ...
    implementation(platform("com.forgerock.sapi.gateway:secure-api-gateway-ob-uk-common-bom:5.0.6"))
