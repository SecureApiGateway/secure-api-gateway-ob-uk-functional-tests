/* ************************************************* */
/* profile for ob-sandbox-v2 (Release Environment)   */
/* ************************************************* */
 ...
 */
// servers
val environment by extra("ob-sandbox-v2")

val platformServer by extra("https://openam-sapig-relenvs.forgeblocks.com")
val amCookieName by extra("866fd071376b506")
